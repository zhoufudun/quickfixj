...
public class CrossOrderCancelRequest extends Message {
	...
	public void set(quickfix.fix50sp1.component.SideCrossOrdCxlGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.SideCrossOrdCxlGrp get(quickfix.fix50sp1.component.SideCrossOrdCxlGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.SideCrossOrdCxlGrp getSideCrossOrdCxlGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.SideCrossOrdCxlGrp());
	}
