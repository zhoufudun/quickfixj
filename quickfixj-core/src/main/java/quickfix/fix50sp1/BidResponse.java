...
public class BidResponse extends Message {
	...
	public void set(quickfix.fix50sp1.component.BidCompRspGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.BidCompRspGrp get(quickfix.fix50sp1.component.BidCompRspGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.BidCompRspGrp getBidCompRspGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.BidCompRspGrp());
	}
