...
public class TradeCaptureReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.TrdCapRptSideGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.TrdCapRptSideGrp get(quickfix.fix50sp1.component.TrdCapRptSideGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.TrdCapRptSideGrp getTrdCapRptSideGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.TrdCapRptSideGrp());
	}
