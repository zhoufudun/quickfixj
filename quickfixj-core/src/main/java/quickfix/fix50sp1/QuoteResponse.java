...
public class QuoteResponse extends Message {
	...
	public void set(quickfix.fix50sp1.component.LegQuotGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.LegQuotGrp get(quickfix.fix50sp1.component.LegQuotGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.LegQuotGrp getLegQuotGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.LegQuotGrp());
	}
