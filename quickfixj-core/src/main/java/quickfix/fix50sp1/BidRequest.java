...
public class BidRequest extends Message {
	...
	public void set(quickfix.fix50sp1.component.BidDescReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.BidDescReqGrp get(quickfix.fix50sp1.component.BidDescReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.BidDescReqGrp getBidDescReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.BidDescReqGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.BidCompReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.BidCompReqGrp get(quickfix.fix50sp1.component.BidCompReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.BidCompReqGrp getBidCompReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.BidCompReqGrp());
	}
