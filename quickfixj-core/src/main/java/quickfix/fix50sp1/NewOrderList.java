...
public class NewOrderList extends Message {
	...
	public void set(quickfix.fix50sp1.component.ListOrdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.ListOrdGrp get(quickfix.fix50sp1.component.ListOrdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.ListOrdGrp getListOrdGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.ListOrdGrp());
	}
	...
	public static class NoOrders extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {11, 526, 67, 583, 160, 453, 229, 75, 1, 660, 581, 589, 590, 70, 591, 78, 63, 64, 544, 635, 21, 18, 110, 1089, 1090, 1138, 1082, 1083, 1084, 1085, 1086, 1087, 1088, 111, 100, 1133, 386, 81, 55, 65, 48, 22, 454, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 967, 968, 206, 231, 969, 1146, 996, 1147, 1191, 1192, 1193, 1194, 1195, 1196, 1197, 1198, 1199, 1200, 201, 1244, 1242, 997, 223, 207, 970, 971, 106, 348, 349, 107, 350, 351, 1184, 1185, 1186, 691, 667, 875, 876, 864, 873, 874, 1018, 711, 140, 54, 401, 114, 60, 232, 854, 38, 152, 516, 468, 469, 40, 423, 44, 1092, 99, 1100, 1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108, 1109, 1110, 1111, 1112, 1113, 1114, 218, 220, 221, 222, 662, 663, 699, 761, 235, 236, 701, 696, 697, 698, 15, 376, 377, 23, 117, 1080, 1081, 59, 168, 432, 126, 427, 12, 13, 479, 497, 528, 529, 1091, 582, 121, 120, 775, 58, 354, 355, 193, 192, 640, 77, 203, 210, 211, 1094, 835, 836, 837, 838, 840, 1096, 1097, 1098, 1099, 388, 389, 841, 842, 843, 844, 846, 847, 957, 848, 849, 494, 0};
