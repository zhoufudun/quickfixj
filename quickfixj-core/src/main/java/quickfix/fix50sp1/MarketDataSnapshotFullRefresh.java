...
public class MarketDataSnapshotFullRefresh extends Message {
	...
	public void set(quickfix.fix50sp1.component.MDFullGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.MDFullGrp get(quickfix.fix50sp1.component.MDFullGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.MDFullGrp getMDFullGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.MDFullGrp());
	}
