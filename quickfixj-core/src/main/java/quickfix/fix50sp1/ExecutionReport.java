...
public class ExecutionReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.ContraGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.ContraGrp get(quickfix.fix50sp1.component.ContraGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.ContraGrp getContraGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.ContraGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.FillsGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.FillsGrp get(quickfix.fix50sp1.component.FillsGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.FillsGrp getFillsGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.FillsGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.InstrmtLegExecGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.InstrmtLegExecGrp get(quickfix.fix50sp1.component.InstrmtLegExecGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.InstrmtLegExecGrp getInstrmtLegExecGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.InstrmtLegExecGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 1212, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 999, 1224, 1421, 1422, 1001, 1420, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 1358, 1017, 566, 687, 685, 690, 683, 1366, 670, 564, 565, 948, 654, 587, 588, 637, 675, 1073, 1074, 1075, 1379, 1381, 1383, 1384, 1418, 0};
	...
	public void set(quickfix.fix50sp1.component.LegPreAllocGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.LegPreAllocGrp get(quickfix.fix50sp1.component.LegPreAllocGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.LegPreAllocGrp getLegPreAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.LegPreAllocGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.NestedParties3 component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.NestedParties3 get(quickfix.fix50sp1.component.NestedParties3 component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.NestedParties3 getNestedParties3() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.NestedParties3());
	}
	...
	public void set(quickfix.fix50sp1.component.NstdPtys3SubGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.NstdPtys3SubGrp get(quickfix.fix50sp1.component.NstdPtys3SubGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.NstdPtys3SubGrp getNstdPtys3SubGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.NstdPtys3SubGrp());
	}
