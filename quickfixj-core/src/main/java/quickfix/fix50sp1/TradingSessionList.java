...
public class TradingSessionList extends Message {
	...
	public void set(quickfix.fix50sp1.component.TrdSessLstGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.TrdSessLstGrp get(quickfix.fix50sp1.component.TrdSessLstGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.TrdSessLstGrp getTrdSessLstGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.TrdSessLstGrp());
	}
	...
	public static class NoTradingSessions extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {336, 625, 207, 1301, 1300, 1326, 338, 339, 325, 340, 567, 341, 342, 343, 344, 345, 387, 1237, 1239, 1232, 1235, 1141, 58, 354, 355, 0};
