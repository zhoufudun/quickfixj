...
public class TradeCaptureReportRequest extends Message {
	...
	public void set(quickfix.fix50sp1.component.TrdCapDtGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.TrdCapDtGrp get(quickfix.fix50sp1.component.TrdCapDtGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.TrdCapDtGrp getTrdCapDtGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.TrdCapDtGrp());
	}
