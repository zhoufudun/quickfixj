...
public class ContraryIntentionReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.ExpirationQty component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.ExpirationQty get(quickfix.fix50sp1.component.ExpirationQty component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.ExpirationQty getExpirationQty() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.ExpirationQty());
	}
