...
public class SettlementInstructions extends Message {
	...
	public void set(quickfix.fix50sp1.component.SettlInstGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.SettlInstGrp get(quickfix.fix50sp1.component.SettlInstGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.SettlInstGrp getSettlInstGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.SettlInstGrp());
	}
	...
	public static class NoSettlInst extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {162, 163, 214, 453, 54, 460, 167, 461, 120, 168, 126, 779, 172, 169, 170, 171, 85, 492, 476, 488, 489, 503, 490, 491, 504, 505, 0};
