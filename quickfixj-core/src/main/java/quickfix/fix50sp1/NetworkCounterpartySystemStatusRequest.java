...
public class NetworkCounterpartySystemStatusRequest extends Message {
	...
	public void set(quickfix.fix50sp1.component.CompIDReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.CompIDReqGrp get(quickfix.fix50sp1.component.CompIDReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.CompIDReqGrp getCompIDReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.CompIDReqGrp());
	}
