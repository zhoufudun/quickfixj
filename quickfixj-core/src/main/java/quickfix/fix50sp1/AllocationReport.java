...
public class AllocationReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.ExecAllocGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.ExecAllocGrp get(quickfix.fix50sp1.component.ExecAllocGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.ExecAllocGrp getExecAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.ExecAllocGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.AllocGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.AllocGrp get(quickfix.fix50sp1.component.AllocGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.AllocGrp getAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.AllocGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.SettlInstructionsData component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.SettlInstructionsData get(quickfix.fix50sp1.component.SettlInstructionsData component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.SettlInstructionsData getSettlInstructionsData() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.SettlInstructionsData());
	}
	...
	public void set(quickfix.fix50sp1.component.DlvyInstGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.DlvyInstGrp get(quickfix.fix50sp1.component.DlvyInstGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.DlvyInstGrp getDlvyInstGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.DlvyInstGrp());
	}
