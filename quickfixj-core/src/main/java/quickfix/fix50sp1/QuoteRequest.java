...
public class QuoteRequest extends Message {
	...
	public void set(quickfix.fix50sp1.component.QuotReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.QuotReqGrp get(quickfix.fix50sp1.component.QuotReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.QuotReqGrp getQuotReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.QuotReqGrp());
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 967, 968, 206, 231, 969, 1146, 996, 1147, 1191, 1192, 1193, 1194, 1195, 1196, 1197, 1198, 1199, 1200, 201, 1244, 1242, 997, 223, 207, 970, 971, 106, 348, 349, 107, 350, 351, 1184, 1185, 1186, 691, 667, 875, 876, 864, 873, 874, 1018, 913, 914, 915, 918, 788, 916, 917, 919, 898, 711, 140, 303, 537, 336, 625, 229, 54, 854, 38, 152, 516, 468, 469, 110, 63, 64, 193, 192, 15, 232, 1, 660, 581, 555, 735, 692, 40, 62, 126, 60, 218, 220, 221, 222, 662, 663, 699, 761, 423, 44, 640, 235, 236, 701, 696, 697, 698, 453, 0};
