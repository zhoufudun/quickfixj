...
public class MarketDataIncrementalRefresh extends Message {
	...
	public void set(quickfix.fix50sp1.component.MDIncGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.MDIncGrp get(quickfix.fix50sp1.component.MDIncGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.MDIncGrp getMDIncGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.MDIncGrp());
	}
	...
	public static class NoMDEntries extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {279, 285, 1173, 264, 269, 278, 280, 55, 65, 48, 22, 454, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965, 224, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 967, 968, 206, 231, 969, 1146, 996, 1147, 1191, 1192, 1193, 1194, 1195, 1196, 1197, 1198, 1199, 1200, 201, 1244, 1242, 997, 223, 207, 970, 971, 106, 348, 349, 107, 350, 351, 1184, 1185, 1186, 691, 667, 875, 876, 864, 873, 874, 1018, 711, 555, 291, 292, 270, 423, 235, 236, 701, 696, 697, 698, 218, 220, 221, 222, 662, 663, 699, 761, 40, 15, 271, 1177, 1093, 272, 273, 274, 275, 336, 625, 326, 327, 276, 277, 828, 574, 282, 283, 284, 286, 59, 432, 126, 110, 18, 287, 37, 198, 299, 1003, 288, 289, 346, 290, 546, 811, 451, 58, 354, 355, 1023, 528, 1024, 332, 333, 1020, 63, 64, 483, 60, 1070, 83, 1048, 1026, 1027, 1175, 453, 0};
	...
	public void set(quickfix.fix50sp1.component.SecSizesGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.SecSizesGrp get(quickfix.fix50sp1.component.SecSizesGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.SecSizesGrp getSecSizesGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.SecSizesGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.StatsIndGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.StatsIndGrp get(quickfix.fix50sp1.component.StatsIndGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.StatsIndGrp getStatsIndGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.StatsIndGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.RoutingGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.RoutingGrp get(quickfix.fix50sp1.component.RoutingGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.RoutingGrp getRoutingGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.RoutingGrp());
	}
