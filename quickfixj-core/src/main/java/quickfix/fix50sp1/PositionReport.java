...
public class PositionReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.PosUndInstrmtGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.PosUndInstrmtGrp get(quickfix.fix50sp1.component.PosUndInstrmtGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.PosUndInstrmtGrp getPosUndInstrmtGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.PosUndInstrmtGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.UnderlyingAmount component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.UnderlyingAmount get(quickfix.fix50sp1.component.UnderlyingAmount component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.UnderlyingAmount getUnderlyingAmount() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.UnderlyingAmount());
	}
	...
	public void set(quickfix.fix50sp1.component.PositionQty component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.PositionQty get(quickfix.fix50sp1.component.PositionQty component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.PositionQty getPositionQty() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.PositionQty());
	}
