...
public class RegistrationInstructions extends Message {
	...
	public void set(quickfix.fix50sp1.component.RgstDtlsGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.RgstDtlsGrp get(quickfix.fix50sp1.component.RgstDtlsGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.RgstDtlsGrp getRgstDtlsGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.RgstDtlsGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.RgstDistInstGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.RgstDistInstGrp get(quickfix.fix50sp1.component.RgstDistInstGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.RgstDistInstGrp getRgstDistInstGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.RgstDistInstGrp());
	}
