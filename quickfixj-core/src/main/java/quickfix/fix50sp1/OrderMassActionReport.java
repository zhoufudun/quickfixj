...
public class OrderMassActionReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.AffectedOrdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.AffectedOrdGrp get(quickfix.fix50sp1.component.AffectedOrdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.AffectedOrdGrp getAffectedOrdGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.AffectedOrdGrp());
	}
	...
	public void set(quickfix.fix50sp1.component.NotAffectedOrdersGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.NotAffectedOrdersGrp get(quickfix.fix50sp1.component.NotAffectedOrdersGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.NotAffectedOrdersGrp getNotAffectedOrdersGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.NotAffectedOrdersGrp());
	}
