...
public class QuoteStatusReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.LegQuotStatGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.LegQuotStatGrp get(quickfix.fix50sp1.component.LegQuotStatGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.LegQuotStatGrp getLegQuotStatGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.LegQuotStatGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 1212, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 999, 1224, 1421, 1422, 1001, 1420, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 1358, 1017, 566, 687, 685, 690, 587, 588, 683, 539, 0};
