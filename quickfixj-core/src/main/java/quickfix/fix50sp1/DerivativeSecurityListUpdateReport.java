...
public class DerivativeSecurityListUpdateReport extends Message {
	...
	public void set(quickfix.fix50sp1.component.RelSymDerivSecUpdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp1.component.RelSymDerivSecUpdGrp get(quickfix.fix50sp1.component.RelSymDerivSecUpdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp1.component.RelSymDerivSecUpdGrp getRelSymDerivSecUpdGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp1.component.RelSymDerivSecUpdGrp());
	}
