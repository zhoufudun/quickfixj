...
public class ApplicationMessageReport extends Message {
	...
	public void set(quickfix.fix50sp2.component.ApplIDReportGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.ApplIDReportGrp get(quickfix.fix50sp2.component.ApplIDReportGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.ApplIDReportGrp getApplIDReportGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.ApplIDReportGrp());
	}
