...
public class RFQRequest extends Message {
	...
	public void set(quickfix.fix50sp2.component.RFQReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.RFQReqGrp get(quickfix.fix50sp2.component.RFQReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.RFQReqGrp getRFQReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.RFQReqGrp());
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {55, 65, 48, 22, 454, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965, 224, 1449, 1450, 1451, 1452, 1457, 1458, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 967, 968, 1478, 1479, 1480, 1481, 206, 231, 1435, 1439, 969, 1146, 996, 1147, 1191, 1192, 1193, 1194, 1482, 1195, 1196, 1197, 1198, 1199, 1200, 201, 1244, 1242, 997, 223, 207, 970, 971, 106, 348, 349, 107, 350, 351, 1184, 1185, 1186, 691, 667, 875, 876, 864, 873, 874, 1018, 1483, 711, 555, 140, 303, 537, 336, 625, 0};
