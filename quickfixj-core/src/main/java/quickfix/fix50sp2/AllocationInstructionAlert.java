...
public class AllocationInstructionAlert extends Message {
	...
	public void set(quickfix.fix50sp2.component.OrdAllocGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.OrdAllocGrp get(quickfix.fix50sp2.component.OrdAllocGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.OrdAllocGrp getOrdAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.OrdAllocGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.ExecAllocGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.ExecAllocGrp get(quickfix.fix50sp2.component.ExecAllocGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.ExecAllocGrp getExecAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.ExecAllocGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.AllocGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.AllocGrp get(quickfix.fix50sp2.component.AllocGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.AllocGrp getAllocGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.AllocGrp());
	}
