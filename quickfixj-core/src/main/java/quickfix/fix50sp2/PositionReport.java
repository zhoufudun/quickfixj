...
public class PositionReport extends Message {
	...
	public void set(quickfix.fix50sp2.component.PosUndInstrmtGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.PosUndInstrmtGrp get(quickfix.fix50sp2.component.PosUndInstrmtGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.PosUndInstrmtGrp getPosUndInstrmtGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.PosUndInstrmtGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.UnderlyingAmount component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.UnderlyingAmount get(quickfix.fix50sp2.component.UnderlyingAmount component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.UnderlyingAmount getUnderlyingAmount() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.UnderlyingAmount());
	}
	...
	public void set(quickfix.fix50sp2.component.PositionQty component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.PositionQty get(quickfix.fix50sp2.component.PositionQty component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.PositionQty getPositionQty() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.PositionQty());
	}
	...
	public static class NoPositions extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {703, 704, 705, 706, 976, 539, 0};
