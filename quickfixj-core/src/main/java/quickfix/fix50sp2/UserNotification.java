...
public class UserNotification extends Message {
	...
	public void set(quickfix.fix50sp2.component.UsernameGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.UsernameGrp get(quickfix.fix50sp2.component.UsernameGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.UsernameGrp getUsernameGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.UsernameGrp());
	}
