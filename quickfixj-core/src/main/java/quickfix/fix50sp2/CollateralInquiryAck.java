...
public class CollateralInquiryAck extends Message {
	...
	public void set(quickfix.fix50sp2.component.CollInqQualGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.CollInqQualGrp get(quickfix.fix50sp2.component.CollInqQualGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.CollInqQualGrp getCollInqQualGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.CollInqQualGrp());
	}
