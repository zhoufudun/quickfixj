...
public class Confirmation extends Message {
	...
	public void set(quickfix.fix50sp2.component.CpctyConfGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.CpctyConfGrp get(quickfix.fix50sp2.component.CpctyConfGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.CpctyConfGrp getCpctyConfGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.CpctyConfGrp());
	}
