...
public class SettlementInstructions extends Message {
	...
	public void set(quickfix.fix50sp2.component.SettlInstGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.SettlInstGrp get(quickfix.fix50sp2.component.SettlInstGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.SettlInstGrp getSettlInstGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.SettlInstGrp());
	}
