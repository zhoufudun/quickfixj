...
public class SecurityListUpdateReport extends Message {
	...
	public void set(quickfix.fix50sp2.component.SecLstUpdRelSymGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.SecLstUpdRelSymGrp get(quickfix.fix50sp2.component.SecLstUpdRelSymGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.SecLstUpdRelSymGrp getSecLstUpdRelSymGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.SecLstUpdRelSymGrp());
	}
	...
	public static class NoRelatedSym extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {1324, 55, 65, 48, 22, 454, 460, 1227, 1151, 461, 167, 762, 200, 541, 1079, 966, 1049, 965, 224, 1449, 1450, 1451, 1452, 1457, 1458, 225, 239, 226, 227, 228, 255, 543, 470, 471, 472, 240, 202, 947, 967, 968, 1478, 1479, 1480, 1481, 206, 231, 1435, 1439, 969, 1146, 996, 1147, 1191, 1192, 1193, 1194, 1482, 1195, 1196, 1197, 1198, 1199, 1200, 201, 1244, 1242, 997, 223, 207, 970, 971, 106, 348, 349, 107, 350, 351, 1184, 1185, 1186, 691, 667, 875, 876, 864, 873, 874, 1018, 1483, 668, 869, 870, 913, 914, 915, 918, 788, 916, 917, 919, 898, 1205, 1234, 1306, 1148, 1149, 1150, 827, 562, 1140, 1143, 1144, 1245, 561, 1377, 1378, 423, 1309, 1312, 1201, 711, 15, 232, 555, 218, 220, 221, 222, 662, 663, 699, 761, 235, 236, 701, 696, 697, 698, 1504, 58, 354, 355, 0};
	...
	public void set(quickfix.fix50sp2.component.SecLstUpdRelSymsLegGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.SecLstUpdRelSymsLegGrp get(quickfix.fix50sp2.component.SecLstUpdRelSymsLegGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.SecLstUpdRelSymsLegGrp getSecLstUpdRelSymsLegGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.SecLstUpdRelSymsLegGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 1212, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 1436, 1440, 999, 1224, 1421, 1422, 1001, 1420, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 1358, 1017, 566, 690, 587, 683, 676, 677, 678, 679, 680, 0};
	...
	public void set(quickfix.fix50sp2.component.LegBenchmarkCurveData component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.LegBenchmarkCurveData get(quickfix.fix50sp2.component.LegBenchmarkCurveData component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.LegBenchmarkCurveData getLegBenchmarkCurveData() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.LegBenchmarkCurveData());
	}
