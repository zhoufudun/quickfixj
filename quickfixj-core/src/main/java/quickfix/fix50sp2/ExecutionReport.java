...
public class ExecutionReport extends Message {
	...
	public void set(quickfix.fix50sp2.component.ContraGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.ContraGrp get(quickfix.fix50sp2.component.ContraGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.ContraGrp getContraGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.ContraGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.FillsGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.FillsGrp get(quickfix.fix50sp2.component.FillsGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.FillsGrp getFillsGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.FillsGrp());
	}
	...
	public quickfix.fix50sp2.component.InstrmtLegExecGrp get(quickfix.fix50sp2.component.InstrmtLegExecGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.InstrmtLegExecGrp getInstrmtLegExecGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.InstrmtLegExecGrp());
	}
