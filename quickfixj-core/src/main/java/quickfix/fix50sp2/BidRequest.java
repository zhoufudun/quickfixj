...
public class BidRequest extends Message {
	...
	public void set(quickfix.fix50sp2.component.BidDescReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.BidDescReqGrp get(quickfix.fix50sp2.component.BidDescReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.BidDescReqGrp getBidDescReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.BidDescReqGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.BidCompReqGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.BidCompReqGrp get(quickfix.fix50sp2.component.BidCompReqGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.BidCompReqGrp getBidCompReqGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.BidCompReqGrp());
	}
