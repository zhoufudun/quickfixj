...
public class NetworkCounterpartySystemStatusResponse extends Message {
	...
	public void set(quickfix.fix50sp2.component.CompIDStatGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.CompIDStatGrp get(quickfix.fix50sp2.component.CompIDStatGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.CompIDStatGrp getCompIDStatGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.CompIDStatGrp());
	}
