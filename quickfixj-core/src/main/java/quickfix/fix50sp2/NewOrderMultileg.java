...
public class NewOrderMultileg extends Message {
	...
	public void set(quickfix.fix50sp2.component.PreAllocMlegGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.PreAllocMlegGrp get(quickfix.fix50sp2.component.PreAllocMlegGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.PreAllocMlegGrp getPreAllocMlegGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.PreAllocMlegGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.LegOrdGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.LegOrdGrp get(quickfix.fix50sp2.component.LegOrdGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.LegOrdGrp getLegOrdGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.LegOrdGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 1212, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 1436, 1440, 999, 1224, 1421, 1422, 1001, 1420, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 1358, 1017, 566, 687, 690, 683, 1366, 670, 564, 565, 539, 654, 587, 588, 675, 685, 1379, 1381, 1383, 1384, 0};
