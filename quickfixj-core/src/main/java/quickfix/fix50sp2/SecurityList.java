...
public class SecurityList extends Message {
	...
	public void set(quickfix.fix50sp2.component.SecListGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.SecListGrp get(quickfix.fix50sp2.component.SecListGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.SecListGrp getSecListGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.SecListGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.InstrmtLegSecListGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.InstrmtLegSecListGrp get(quickfix.fix50sp2.component.InstrmtLegSecListGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.InstrmtLegSecListGrp getInstrmtLegSecListGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.InstrmtLegSecListGrp());
	}
