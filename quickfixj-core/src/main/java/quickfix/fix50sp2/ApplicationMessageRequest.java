...
public class ApplicationMessageRequest extends Message {
	...
	public void set(quickfix.fix50sp2.component.ApplIDRequestGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.ApplIDRequestGrp get(quickfix.fix50sp2.component.ApplIDRequestGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.ApplIDRequestGrp getApplIDRequestGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.ApplIDRequestGrp());
	}
