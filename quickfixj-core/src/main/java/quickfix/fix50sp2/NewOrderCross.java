...
public class NewOrderCross extends Message {
	...
	public void set(quickfix.fix50sp2.component.SideCrossOrdModGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.SideCrossOrdModGrp get(quickfix.fix50sp2.component.SideCrossOrdModGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.SideCrossOrdModGrp getSideCrossOrdModGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.SideCrossOrdModGrp());
	}
