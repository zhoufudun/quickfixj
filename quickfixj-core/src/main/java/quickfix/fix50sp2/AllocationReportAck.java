...
public class AllocationReportAck extends Message {
	...
	public void set(quickfix.fix50sp2.component.AllocAckGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.AllocAckGrp get(quickfix.fix50sp2.component.AllocAckGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.AllocAckGrp getAllocAckGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.AllocAckGrp());
	}
