...
public class CollateralResponse extends Message {
	...
	public void set(quickfix.fix50sp2.component.ExecCollGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.ExecCollGrp get(quickfix.fix50sp2.component.ExecCollGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.ExecCollGrp getExecCollGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.ExecCollGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.TrdCollGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.TrdCollGrp get(quickfix.fix50sp2.component.TrdCollGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.TrdCollGrp getTrdCollGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.TrdCollGrp());
	}
	...
	public void set(quickfix.fix50sp2.component.UndInstrmtCollGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.UndInstrmtCollGrp get(quickfix.fix50sp2.component.UndInstrmtCollGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.UndInstrmtCollGrp getUndInstrmtCollGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.UndInstrmtCollGrp());
	}
