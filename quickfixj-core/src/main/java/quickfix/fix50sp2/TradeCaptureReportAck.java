...
public class TradeCaptureReportAck extends Message {
	...
	public void set(quickfix.fix50sp2.component.TrdCapRptAckSideGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.TrdCapRptAckSideGrp get(quickfix.fix50sp2.component.TrdCapRptAckSideGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.TrdCapRptAckSideGrp getTrdCapRptAckSideGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.TrdCapRptAckSideGrp());
	}
