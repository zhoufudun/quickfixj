...
public class IOI extends Message {
	...
	public void set(quickfix.fix50sp2.component.InstrmtLegIOIGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.InstrmtLegIOIGrp get(quickfix.fix50sp2.component.InstrmtLegIOIGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.InstrmtLegIOIGrp getInstrmtLegIOIGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.InstrmtLegIOIGrp());
	}
	...
	public static class NoLegs extends Group {
		...
		static final long serialVersionUID = 20050617;
		private static final int[] ORDER = {600, 601, 602, 603, 604, 607, 608, 609, 764, 610, 611, 1212, 248, 249, 250, 251, 252, 253, 257, 599, 596, 597, 598, 254, 612, 942, 613, 614, 1436, 1440, 999, 1224, 1421, 1422, 1001, 1420, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 556, 740, 739, 955, 956, 1358, 1017, 566, 682, 683, 0};
	...
	public void set(quickfix.fix50sp2.component.IOIQualGrp component) {
		setComponent(component);
	}

	public quickfix.fix50sp2.component.IOIQualGrp get(quickfix.fix50sp2.component.IOIQualGrp component) throws FieldNotFound {
		getComponent(component);
		return component;
	}

	public quickfix.fix50sp2.component.IOIQualGrp getIOIQualGrp() throws FieldNotFound {
		return get(new quickfix.fix50sp2.component.IOIQualGrp());
	}
