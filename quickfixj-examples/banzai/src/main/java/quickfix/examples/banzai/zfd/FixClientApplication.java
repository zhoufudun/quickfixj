...
public class FixClientApplication extends MessageCracker implements Application {
    ...
    public void toAdmin(Message message, SessionID sessionID) {
        ...
        log.warn("toAdmin messageType:{}",message.getClass());
    }

    @Override
    public void fromAdmin(Message message, SessionID sessionID) throws FieldNotFound, IncorrectDataFormat, IncorrectTagValue, RejectLogon {
        log.info("fromAdmin msg 接收管理消息 {}", message);
        log.warn("fromAdmin messageType:{}",message.getClass());
    }

    @Override
    public void toApp(Message message, SessionID sessionID) throws DoNotSend {
        log.info("toApp msg 发送业务消息 {}", message);
        log.warn("toApp messageType:{}",message.getClass());
    }
    ...
    public void fromApp(Message message, SessionID sessionID) throws FieldNotFound, IncorrectDataFormat, IncorrectTagValue, UnsupportedMessageType {
        ...
        log.warn("fromApp messageType:{}",message.getClass());
    }
